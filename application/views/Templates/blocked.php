...
<section id="wrapper" class="error-page">
  <div class="error-box">
    <div class="error-body text-center">
      ...
      <p class="text-muted m-t-30 m-b-30 text-uppercase">Anda tidak memiliki akses ke halaman ini.</p>
      <a href="<?= site_url('Dashboard'); ?>" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Kembali ke Dashboard</a> </div>
