...
<body class="fix-header">
    ...
    <section id="wrapper" class="new-login-register">
        ...
        <div class="new-login-box">
            <div class="white-box">
                <h3 class="box-title m-b-0">Masuk Ke Halaman Admin</h3>
                <small>Masukan ID/Email dan Password Anda dibawah ini :</small>
                ...
                <form class="form-horizontal" id="recoverform" method="post" action="<?= base_url('lupapassword/kirim_link'); ?>">
                    <div class="form-group ">
                        <div class="col-xs-12">
                            ...
                            <p class="text-muted">Masukan Email anda, dan instruksi selanjutnya akan terkirim ke email anda! </p>
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
